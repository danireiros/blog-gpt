...
class XatakaController extends Controller
{
    /**
     * Generar noticias
     */
    ...
    public function getNewsLinks($content, $domain){
        ...
        foreach ($hrefValues as $href) {
            ...
            if (strpos($link, '/autor/') === false && strpos($link, '#to-comments') === false && strpos($link, '/categoria/') === false) {
        ...
        try {
            ...
            if (preg_match($pattern, $data, $matches)) {
                ...
                */
                ...
                /* $content .= strip_tags($content) . PHP_EOL; */
