    ...
    <AppLayout>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="container mt-5">
                <div class="card">
                    <div class="card-body">
                        <h2 class="mb-2 text-xl font-semibold text-gray-900 dark:text-white">OpenAi</h2>
                        <Link class="link-button-default mb-3 hover:text-gray-100" :href="route('openai.completion')">Recibir respuesta</Link>
